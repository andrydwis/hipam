    ...
    <div class="card-body">
        ...
        <form action="{{route('usage.update', [$client, $month, $year])}}" method="post">
            ...
            <div class="mb-4">
                ...
                <input type="number" name="meter_kubik" class="form-control @error('meter_kubik') is-invalid @enderror" placeholder="jumlah pemakaian" value="{{old('meter_kubik') ?? $client->usages->first()->meter_cubic}}">
                @error('meter_kubik')
                <div class="invalid-feedback">
                    {{$message}}
                </div>
