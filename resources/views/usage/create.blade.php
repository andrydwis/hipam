...
<div class="py-4">
    ...
    <div class="d-flex justify-content-between w-100 flex-wrap">
        <div class="mb-3 mb-lg-0">
            <h1 class="h4">Tambah Pemakaian</h1>
            <p class="mb-0">Menambah pemakaian dari pelanggan yang dipilih</p>
        </div>
    </div>
</div>
<div class="card mb-5">
    <div class="card-body">
        ...
        <form action="{{route('usage.store', [$client, $month, $year])}}" method="post">
            @csrf
            <div class="mb-4">
